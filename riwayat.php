...
<head>
    ...
    <link rel="stylesheet" href="vendor/datatables/tambahan/jquery.dataTables.min.css">
    <link rel="stylesheet" href="vendor/datatables/tambahan/buttons.dataTables.min.css">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                      ...
                                      include("koneksi.php");
                                        ...
                                        $no=1;
                                        $ambildata = mysqli_query($links,"select arus, tegangan, daya, waktu from logdata");
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; IPS, Infoematika 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
